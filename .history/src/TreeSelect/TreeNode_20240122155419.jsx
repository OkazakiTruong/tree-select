...
export default function TreeNode({
  ...
  const handleOpen = () => {
    console.log(childrenRef.current.offsetHeight);
    childrenRef.current.style.height = `${childrenRef.current.offsetHeight}px`;
  ...
  return (
    <div>
      ...
      <div
        className={`ml-20 children ${showChildren && "show"}`}
        ref={childrenRef}
      >
        {
          <Tree
